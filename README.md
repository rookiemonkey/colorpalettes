...
This single-page application uses reactjs and a couple of pre-made components available to achive drag-and-drop functionality and some transitions.

Consider checking the repo's issues, all of my todos are in there :smile:

![Screenshot](./colorpalette1.png)
![Screenshot](./colorpalette2.png)
